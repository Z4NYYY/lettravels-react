...
export default function LocationDetail() {
  ...
  return (
    ...
    <div className="bg-gray-50 p-6 rounded-lg shadow border mb-12">
    ...
    {location.activities && (
      <div className="mb-12 bg-gray-50 p-6 rounded-lg shadow border">
    ...
    {location.mapEmbedUrl && (
      <div className="mb-12">
        ...
        <div className="w-full h-[300px] sm:h-[450px] rounded-lg overflow-hidden shadow">
          <iframe
